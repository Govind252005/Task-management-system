...
// Get individual report (own or specified user)
router.get('/individual', reportController_js_1.getIndividualReport);
router.get('/individual/:userId', reportController_js_1.getIndividualReport);
// Get team report (Team Lead and above)
router.get('/team', (0, auth_js_1.authorizeMinRole)('team_lead'), reportController_js_1.getTeamReport);
...
router.get('/department', (0, auth_js_1.authorizeMinRole)('manager'), reportController_js_1.getDepartmentReport);
