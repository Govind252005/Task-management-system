...
timeEntrySchema.statics.getTotalTimeForTask = async function (taskId) {
...
// Static method to get total time for a user in a date range
timeEntrySchema.statics.getUserTimeInRange = async function (userId, startDate, endDate) {
    const result = await this.aggregate([
        {
            $match: {
                userId,
